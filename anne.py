import openai
from anne_prompt import AnnePrompt

class AnneCoach:
    def __init__(self, api_key):
        """Initialize Anne coach with OpenAI API"""
        self.client = openai.OpenAI(api_key=api_key)
        self.prompt_manager = AnnePrompt()
    ...
    def summarize_conversation(self, messages):
        ...
        try:
            response = self.client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "Summarize this coaching conversation in 2-3 sentences, focusing on key themes and client goals."},
